...
public class AccountDialog extends JDialog {
    ...
    private AccountTableModel tableModel = new AccountTableModel();
    ...
    public AccountDialog(java.awt.Frame parent, boolean modal) {
        ...
        AccountListTable.setModel(tableModel);
    }
    ...
    private void DeleteAccountButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_DeleteAccountButtonActionPerformed
        if (AccountListTable.getSelectionModel().getLeadSelectionIndex() >= 0) {
            ...
            tableModel.deleteAccount(AccountListTable.getSelectionModel().getLeadSelectionIndex());
    ...
    private void AddAccountButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AddAccountButtonActionPerformed
        ...
        ReturnCode = tableModel.addAccount(NameTextField.getText(), DescriptionTextField.getText());
        String errorMessage = "";

        switch(ReturnCode) {
            case 0:
                break;
            case 1: errorMessage = "Error Adding account to database.  Make sure the account name you specified does not already exist." ;
                break;
            case 2: errorMessage = "Error Adding account to database, Name is invalid.";
                break;
            case 3: errorMessage = "Error Adding account to database, Description is invalid.";
                break;
        }
