...
public class CategoryDialog extends JDialog {
    ...
    public CategoryDialog(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void AddCategoryButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_AddCategoryButtonActionPerformed
        ...
        ReturnCode = dataModel.AddCategory(NameTextField.getText(), DescriptionTextField.getText(), BudgetValue);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                CategoryDialog dialog = new CategoryDialog(new JFrame(), true);
