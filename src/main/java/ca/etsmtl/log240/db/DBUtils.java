...
public class DBUtils {
    ...
    public static boolean ChkTableAccount(Connection conTst) throws SQLException {
        ...
        try {
            Statement s = conTst.createStatement();
            s.execute("update account set name = 'TEST ENTRY', description = 'TEST Description' where 1=3");
        } catch (SQLException sqle) {
            String theError = (sqle).getSQLState();
            //   System.out.println("  Utils GOT:  " + theError);
            /** If table exists will get -  WARNING 02000: No row was found **/
            if (theError.equals("42X05")) // Table does not exist
            {
                ...
                System.out.println("ChkTableAccount: Incorrect table definition. Drop table account and rerun this program");
                throw sqle;
            } else {
                System.out.println("ChkTableAccount: Unhandled SQLException");
                throw sqle;
            }
        }
        //  System.out.println("Just got the warning - table exists OK ");
    ...
    public static boolean ChkTableCategory(Connection conTst) throws SQLException {
        ...
        try {
            Statement s = conTst.createStatement();
            s.execute("update category set name = 'TEST ENTRY', description = 'TEST Description', budget = 0 where 1=3");
        } catch (SQLException sqle) {
            String theError = (sqle).getSQLState();
            //   System.out.println("  Utils GOT:  " + theError);
            /** If table exists will get -  WARNING 02000: No row was found **/
            if (theError.equals("42X05")) // Table does not exist
            {
                ...
                System.out.println("ChkTableCategory: Incorrect table definition. Drop table account and rerun this program");
                throw sqle;
            } else {
                System.out.println("ChkTableCategory: Unhandled SQLException");
                throw sqle;
            }
        }
        //  System.out.println("Just got the warning - table exists OK ");
    ...
    public static boolean ChkTableLedger(Connection conTst) throws SQLException {
        ...
        try {
            Statement s = conTst.createStatement();
            s.execute("update ledger set account = 'TEST ENTRY', description = 'TEST Description', amount = 0 where 1=3");
        } catch (SQLException sqle) {
            String theError = (sqle).getSQLState();
            //   System.out.println("  Utils GOT:  " + theError);
            /** If table exists will get -  WARNING 02000: No row was found **/
